...
int main()
{
   ...
   xbee.printf("ATMY 0x228\r\n");
   reply_messange(xbee_reply, "setting MY : 0x228");
   xbee.printf("ATDL 0x128\r\n");
   reply_messange(xbee_reply, "setting DL : 0x128");
   ...
   while (sec_pass <= 20)
   {
      ...
      else if (tacc[2] < 0.5 || abs(tacc[0]) > 0.5 || abs(tacc[1]) > 0.5)
	   {
		   for (int k = 0; k < 10; k++)
		   {
			   countnum++;
